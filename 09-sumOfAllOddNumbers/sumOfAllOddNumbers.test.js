...
const sumOfAllOddNumbers = require("./sumOfAllOddNumbers");
const { expect } = require("chai");

describe("the sumOfAllOddNumbers(nums) function", function() {

  it("should return a finite value", function() {
    let submittedSolution = sumOfAllOddNumbers([1,2,3,4,5,6]);
  ...
  it("should return a value that indicates the total amount of numbers that are odd", function() {
    let submittedSolution = sumOfAllOddNumbers([7,8,9,10,11]);
  ...
  it("should pass auxillary test cases", function() {
    ...
    let submittedSolution = sumOfAllOddNumbers;
